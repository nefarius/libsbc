...
Get-AppVeyorArtifacts -Account "nefarius" -Project "libsbc" -Path $Path -Token $Token -Branch $BuildVersion -JobName "Platform: ARM64"

# Download x64 binaries
Get-AppVeyorArtifacts -Account "nefarius" -Project "libsbc" -Path $Path -Token $Token -Branch $BuildVersion -JobName "Platform: x64"

# Download x86 binaries
Get-AppVeyorArtifacts -Account "nefarius" -Project "libsbc" -Path $Path -Token $Token -Branch $BuildVersion -JobName "Platform: x86"


# List of files to sign
$files =    "`".\artifacts\bin\ARM64\*.dll`" " + 
